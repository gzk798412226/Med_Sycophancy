...
class OllamaGemma3_12BTester:
    def __init__(self, model_name="gemma3:12b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_gemma3_12b_sycophancy_results.csv")
