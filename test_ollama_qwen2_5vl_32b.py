...
class OllamaQwen25VL32BTester:
    def __init__(self, model_name="qwen2.5vl:32b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_qwen25vl_32b_sycophancy_results.csv")
...
def main():
    ...
    tester = OllamaQwen25VL32BTester()
