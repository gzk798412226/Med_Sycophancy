...
class OllamaDentoBotTester:
    def __init__(self, model_name="Adiptify/dentobot:latest", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_dentobot_sycophancy_results.csv")
