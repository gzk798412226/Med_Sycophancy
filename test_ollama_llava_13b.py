...
class OllamaLLaVA13BTester:
    def __init__(self, model_name="llava:13b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_llava_13b_sycophancy_results.csv")
