...
class OllamaLLaVAMedTester:
    def __init__(self, model_name="rohithbojja/llava-med-v1.6:latest", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_llavamod_sycophancy_results.csv")
