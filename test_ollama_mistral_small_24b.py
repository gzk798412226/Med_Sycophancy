...
class OllamaMistralSmallTester:
    def __init__(self, model_name="mistral-small3.1:24b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_mistral_small_24b_sycophancy_results.csv")
            ...
            for _, sample in samples_to_process.iterrows():
                try:
                    ...
                    result = {
                        'model': 'ollama_mistral_small_24b',
...
def main():
    ...
    tester = OllamaMistralSmallTester()
