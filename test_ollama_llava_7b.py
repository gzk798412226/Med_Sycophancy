...
class OllamaLLaVA7BTester:
    def __init__(self, model_name="llava:7b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_llava_7b_sycophancy_results.csv")
