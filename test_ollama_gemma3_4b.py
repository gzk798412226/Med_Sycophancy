...
class OllamaGemma3_4BTester:
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_gemma3_4b_sycophancy_results.csv")
