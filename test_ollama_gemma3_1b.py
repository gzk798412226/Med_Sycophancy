...
class OllamaGemma3_1BTester:
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_gemma3_1b_sycophancy_results.csv")
