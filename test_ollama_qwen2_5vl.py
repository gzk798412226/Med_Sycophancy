...
class OllamaQwen25VLTester:
    def __init__(self, model_name="qwen2.5vl:3b", base_url="http://localhost:11434"):
    ...
    def test_samples(self, num_samples=None):
        ...
        try:
            ...
            csv_filename = os.path.join(results_dir, "ollama_qwen25vl_sycophancy_results.csv")
